...
Guidance for coding agents (and humans) writing / updating unit tests in this repo.
...
- Prefer using pytest features and patterns for clarity and maintainability.
---
