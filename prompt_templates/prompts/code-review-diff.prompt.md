---
agent: "agent"
tools: ["vscode/runCommand", "execute", "read", "edit", "search", "todo"]
description: "PR-style review driven by git diff. Fixes changed files, runs linters/typecheck, verifies."
mode: "diff"
---
