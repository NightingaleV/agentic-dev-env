...
Rigorously follow the conventions outlined in `docs/AGENTS.md`. That should be your primary reference for style, structure, and best practices and mandatory reading before starting any documentation task.
